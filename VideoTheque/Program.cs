...
builder.Services.AddScoped(typeof(IAgeRatingsRepository), typeof(AgeRatingRepository));
builder.Services.AddScoped(typeof(IAgeRatingsBusiness), typeof(AgeRatingBusiness));
